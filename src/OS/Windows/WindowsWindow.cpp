...
namespace perun
{
    ...
    LRESULT CALLBACK PerunEngineWndProc(HWND wnd, UINT msg, WPARAM wParam, LPARAM lParam)
    {
        ...
        switch (msg) {
            case WM_KEYDOWN: {
                return KeyDownCallback(core, wParam, lParam);
            }
            case WM_KEYUP: {
                return KeyUpCallback(core, wParam, lParam);
            }
            case WM_CHAR: {
                return KeyCharCallback(core, wParam, lParam);
            }
            case WM_LBUTTONDOWN: {
                return MouseButtonDownCallback(core, MouseCode::LeftButton);
            }
            case WM_MBUTTONDOWN: {
                return MouseButtonDownCallback(core, MouseCode::MiddleButton);
            }
            case WM_RBUTTONDOWN: {
                return MouseButtonDownCallback(core, MouseCode::RightButton);
            }
            case WM_XBUTTONDOWN: {
                return MouseButtonDownCallback(core, HIWORD(wParam) == XBUTTON1 ? MouseCode::AdditionalButton1 : MouseCode::AdditionalButton2);
            }
            case WM_LBUTTONUP: {
                return MouseButtonUpCallback(core, MouseCode::LeftButton);
            }
            case WM_MBUTTONUP: {
                return MouseButtonUpCallback(core, MouseCode::MiddleButton);
            }
            case WM_RBUTTONUP: {
                return MouseButtonUpCallback(core, MouseCode::RightButton);
            }
            case WM_XBUTTONUP: {
                return MouseButtonUpCallback(core, HIWORD(wParam) == XBUTTON1 ? MouseCode::AdditionalButton1 : MouseCode::AdditionalButton2);
            }
            case WM_LBUTTONDBLCLK: {
                return MouseButtonDoubleClickedCallback(core, MouseCode::LeftButton);
            }
            case WM_MBUTTONDBLCLK: {
                return MouseButtonDoubleClickedCallback(core, MouseCode::MiddleButton);
            }
            case WM_RBUTTONDBLCLK: {
                return MouseButtonDoubleClickedCallback(core, MouseCode::RightButton);
            }
            case WM_XBUTTONDBLCLK: {
                return MouseButtonDoubleClickedCallback(core, HIWORD(wParam) == XBUTTON1 ? MouseCode::AdditionalButton1 : MouseCode::AdditionalButton2);
            }
            case WM_MOUSEMOVE: {
                return MouseMoveCallback(core, lParam);
            }
            case WM_MOUSEWHEEL: {
                return MouseScrollCallback(core, wParam);
            }
            case WM_MOUSEHWHEEL: {
                return MouseHorizontalScrollCallback(core, wParam);
            }
            case WM_MOVE:
                [[fallthrough]];
            case WM_MOVING: {
                return WindowMoveCallback(core, lParam);
            }
            case WM_SIZE:
                [[fallthrough]];
            case WM_SIZING: {
                return WindowSizeCallback(core, lParam);
            }
            case WM_ACTIVATE: {
                return WindowFocusCallback(core, wParam);
            }
            case WM_CREATE: {
                return WindowCreateCallback(core);
            }
            case WM_CLOSE: {
                return WindowDestroyCallback(core);
            }
            case WM_SYSCOMMAND: {
                switch (wParam) {
                    case SC_MINIMIZE: {
                        return WindowMinimizeCallback(core);
                    }
                    case SC_MAXIMIZE: {
                        return WindowMaximizeCallback(core);
                    }
                    default: {
        ...
        LRESULT WindowFocusCallback(auto& core, WPARAM wParam)
        {
            switch (wParam) {
                case WA_ACTIVE:
                    [[fallthrough]];
                case WA_CLICKACTIVE: {
                    core.submit(new WindowGainedFocusEvent{});
                    return 0;
                }
                case WA_INACTIVE:
                    [[fallthrough]];
                default: {
                    core.submit(new WindowLostFocusEvent{});
                    return 0;
                }
            }
        }
