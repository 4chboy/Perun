...
def write_cmake_source_files(module_name, module_path, main_sources):
...
if __name__ == '__main__':
    ...
    for module in modules:
        ...
        main_sources = collect_sources(module_path)
        write_cmake_source_files(module_name, module_path, main_sources)
